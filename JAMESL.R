...
dat %>%
  ...
  layer_density(type, levels_density = 20,levels_contour = 4,alpha = 1/3,n = 200,density = TRUE,contour = TRUE)
...
bg = par("bg"), grid = FALSE, nb.grids = 3, morphospace = TRUE,
